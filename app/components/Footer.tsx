...
<a className="bg-primary text-on-primary px-10 py-5 font-display text-headline-lg-mobile font-bold uppercase tracking-tighter" href="mailto:hello@ekramasif.com">hello@ekramasif.com</a>
</div>
</div>
</section>
...
<div className="font-display text-headline-lg font-bold tracking-tighter text-on-surface uppercase">EKRAM ASIF</div>
<p className="text-on-surface-variant text-body-md max-w-xs">Software Architect specializing in high-performance backend systems and enterprise AI integration.</p>
...
<span className="material-symbols-outlined text-on-surface-variant hover:text-primary cursor-pointer" data-icon="code">code</span>
<span className="material-symbols-outlined text-on-surface-variant hover:text-primary cursor-pointer" data-icon="database">database</span>
<span className="material-symbols-outlined text-on-surface-variant hover:text-primary cursor-pointer" data-icon="terminal">terminal</span>
</div>
</div>
</div>
</div>
